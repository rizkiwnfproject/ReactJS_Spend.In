            ...
            <div className="bg-primary-0 py-8 lg:py-0">
                <div className="w-full max-w-10/12 lg:max-w-10/12 mx-auto lg:max-h-screen">
                    <div className="flex flex-col w-full lg:h-screen mx-auto items-center justify-center gap-8 lg:gap-16">
                        <div className="flex flex-col gap-3 lg:gap-6 lg:text-center">
                            <div className="flex flex-col gap-3 w-[160px] lg:w-auto ">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 w-full gap-8 lg:gap-0">
                            <div className="pt-3 flex flex-col gap-3.5 lg:gap-11">
                                <div className="flex gap-3 lg:gap-8 w-full">
                                    <ButtonElement typeButton='svg' path='benefit' image='wallet' padding='px-2 lg:px-3' rounded='rounded -md lg:rounded-xl' classname='h-7 lg:h-12.5 flex justify-center items-center' classnamePict='w-5 lg:w-auto h-5 lg:h-auto' />
                                ...
                                <div className="flex gap-3 lg:gap-8 w-full">
                                    <ButtonElement typeButton='svg' path='benefit' image='clear' padding='px-2 lg:px-3' rounded='rounded -md lg:rounded-xl' classname='h-7 lg:h-12.5 flex justify-center items-center' classnamePict='w-5 lg:w-auto h-5 lg:h-auto' />
                                    <div className="flex flex-col max-w-[500px] gap-3">
                                        <TextElement type="2xl_600" textColor="text-secondary-900" textTransform="" classname="">
                                ...
                                <div className="flex gap-3 lg:gap-8 w-full">
                                    <ButtonElement typeButton='svg' path='benefit' image='cards' padding='px-2 lg:px-3' rounded='rounded -md lg:rounded-xl' classname='h-7 lg:h-12.5 flex justify-center items-center' classnamePict='w-5 lg:w-auto h-5 lg:h-auto' />
                                    <div className="flex flex-col max-w-[500px] gap-3">
                                        <TextElement type="2xl_600" textColor="text-secondary-900" textTransform="" classname="">
                            ...
                            <div className="">
                                <div className="relative w-full h-[275px] lg:w-[621px] lg:h-[410px] bg-secondary-100/40 rounded-xl">
                                    ...
                                    <div className="lg:w-[350px] h-[250px] overflow-hidden rounded-none lg:rounded-t-lg absolute bottom-0 left-0 lg:left-12 z-1">
                                        <ImageElement
                                            path="benefit"
                                            image="benefit-2"
                                            format="svg"
                                    ...
                                    <div className="absolute bottom-0 left-7 lg:left-10 z-2 w-25 lg:w-40 h-43 lg:h-62.5 bg-linear-to-l from-information-500/80 to-information500/50 rounded-l-xl"></div>
