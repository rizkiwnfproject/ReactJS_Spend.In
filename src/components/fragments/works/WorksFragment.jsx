        ...
        <>
            <div className="bg-secondary-700 py-8 lg:py-0">
                <div className="w-full max-w-10/12 lg:max-w-10/12 mx-auto lg:max-h-screen">
                    <div className="grid grid-cols-1 lg:grid-cols-2 w-full lg:h-screen lg:items-center lg:justify-center gap-8 lg:gap-0">
                        <div className="order-2 lg:order-1 relative bg-secondary-100 lg:w-[588px] h-[300px] lg:h-[536px] rounded-xl">
                            {/* dikasih overlay */}
                        ...
                        <div className="order-1 lg:order-2 flex flex-col gap-8">
                            ...
                            <div className="bg-linear-to-br from-secondary-500 to-secondary-500/10 max-w-[550px] w-full h-auto rounded-lg py-5 lg:py-10 pl-7 lg:pl-14 relative">
